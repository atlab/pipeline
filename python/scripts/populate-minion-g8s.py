...
for pipe in [reso, meso]:
    ...
    pipe.Segmentation.populate(next_scans, {'segmentation_method': 10}, reserve_jobs=True, suppress_errors=True)
    ...
    time.sleep(60)
    pipe.Activity.populate(next_scans.proj(), {'spike_method': 7}, reserve_jobs=True, suppress_errors=True)
